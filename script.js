...
function renderUnit1Steps() {
    ...
    if (gridEl) {
        ...
        lesson.steps.forEach((step, i) => {
            ...
            card.innerHTML = `<span class='step-icon' style="font-size: 2.5rem; display: block; margin-bottom: 1rem;">${step.icon}</span><span class='step-title' style="font-size: 1.25rem; font-weight: 700; color: #000000;">${step.title}</span>`;
